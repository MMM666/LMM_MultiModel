...
public class ModelLittleMaid_Yomu extends LMM_ModelLittleMaid_Archetype {
	...
	//	Skirt1.setRotationPointLM(0F, 0F+pyoffset, 0F);
		...
		Collar1.setRotationPointLM(0.0F,1.0F,-2.2F);
		...
		Collar2.setRotationPointLM(0.0F,1.0F,-2.2F);
		...
		Collar3.setRotationPointLM(0.0F,1.0F,-2.2F);
		...
		Collar4.setRotationPointLM(0.0F,1.0F,-2.2F);
		...
		Collar5.setRotationPointLM(1.5F,0.1F,-1.99F);
		...
		Collar6.setRotationPointLM(-1.5F,0.1F,-1.99F);
		...
		Collar7.setRotationPointLM(0.0F,0.08F,1.4F);
		...
		Best1.setRotationPointLM(0.0F,3.0F,-2.001F);
		...
		Best2.setRotationPointLM(0.0F,3.0F,-2.001F);
		...
		Patch.setRotationPointLM(0.8F,1.6F,-2.002F);
		...
		Ribon4.setRotationPointLM(0.0F,1.7F,-2.2F);
		...
		Ribon5.setRotationPointLM(0.3F,1.9F,-2.2F);
		...
		Ribon6.setRotationPointLM(-0.3F,1.9F,-2.2F);
	...
	//	BradeC.setPreRotationPointLM(3F,3.5F,-2F);
		BradeC.setRotationPointLM(0.2F,-0.3F,-0.9F);
	...
	//	setRotationDeg(BradeC,-30F,0F,0F);
		...
		Brade4.setRotationPointLM(3F,3.5F,7.89F);
	...
	//	setLivingAnimationsLM((LMM_EntityLittleMaid)entity,0f,0f,0f);
	//	moving((EntityLiving)entity,Hanrei1,-5f,0f,0f);
	...
	public void setLivingAnimations(EntityLiving entityliving, float f, float f1, float f2)
	{
		...
		if (modelCaps != null) {
			if(modelCaps.getCapsValueBoolean(caps_isOpenInv))
			{
				int IdIndex;
				try
				{
	...
	public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity maid)
	{
		...
		HanreiC.rotationPointX=x1+MathHelper.cos((f2+maid.entityId+0.01F*f4)*0.11F) * 0.5F;
		HanreiC.rotationPointZ=z1+MathHelper.cos((f2+maid.entityId+0.01F*f4)*0.07F) * 0.5F;
		HanreiC.rotationPointY=y1+MathHelper.cos((f2+maid.entityId+0.01F*f4)*0.13F) * 0.5F;
