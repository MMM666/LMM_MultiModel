...
public class ModelLittleMaid_Tenshi extends LMM_ModelLittleMaid_Archetype {
	...
	public void initModel(float psize, float pyoffset) {
        ...
        Patch3.setRotationPointLM(-0.5F,0.5F,-2.002F);
		...
		Patch1.setRotationPointLM(0F,0F,0.0F);
		...
		Patch2.setRotationPointLM(0F,0F,0.0F);
	...
	//	Skirt1.setRotationPointLM(0F, 0F+pyoffset, 0F);
		...
		Ribon4.setRotationPointLM(0.0F,0.7F,-2.2F);
		...
		Ribon5.setRotationPointLM(0.3F,0.7F,-2.2F);
		...
		Ribon6.setRotationPointLM(-0.3F,0.7F,-2.2F);
		...
		PlateR1.setRotationPointLM(-3.0F,4.6F-pyoffset+1.0F,0.0F);
		...
		PlateR2.setRotationPointLM(-3.0F,4.6F-pyoffset+1.0F,2.0F);
		...
		PlateR3.setRotationPointLM(-3.0F,4.6F-pyoffset+1.0F,-2.0F);
		...
		PlateR4.setRotationPointLM(-4.5F,6.3F-pyoffset+1.0F,0.0F);
		...
		PlateR5.setRotationPointLM(-4.5F,6.3F-pyoffset+1.0F,2.5F);
		...
		PlateR6.setRotationPointLM(-4.5F,6.3F-pyoffset+1.0F,-2.5F);
		...
		PlateL1.setRotationPointLM(3.0F,4.6F-pyoffset+1.0F,0.0F);
		...
		PlateL2.setRotationPointLM(3.0F,4.6F-pyoffset+1.0F,2.0F);
		...
		PlateL3.setRotationPointLM(3.0F,4.6F-pyoffset+1.0F,-2.0F);
		...
		PlateL4.setRotationPointLM(4.5F,6.3F-pyoffset+1.0F,0.0F);
		...
		PlateL5.setRotationPointLM(4.5F,6.3F-pyoffset+1.0F,2.5F);
		...
		PlateL6.setRotationPointLM(4.5F,6.3F-pyoffset+1.0F,-2.5F);
	...
	public void setLivingAnimations(EntityLiving entityliving, float f, float f1, float f2)
	{
		...
		float f3 = (float)entityliving.ticksExisted + t + entityIdFactor;
		...
		if(entityliving.getCurrentArmor(3)!=null){
	...
	@Override
	public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity maid)
	{
		super.setRotationAngles(f, f1, f2, f3, f4, f5,maid);
